...
func (t *autoTransferWorkflow) checkFranchise(ctx context.Context, executionData *ExecutionData) (*ExecutionData, error) {
	...
	executionData.SetActivity(autoTransferSaveTransactionHeaderActivity)
