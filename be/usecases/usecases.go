...
func NewUsecases(repo *repositories.Repositories,
	...
	return &Usecases{
		...
		TransactionUsecase: newTransactionUsecase(repo.TransactionHeaderRepository, repo.TransactionDetailRepository, repo.CartRepository, repo.UserRepository, repo.CafeRepository, repo.ProductRepository, repo.CafeProductRepository, repo.Transaction, cache.TransactionCache, cache.ProductCache, midtrans),
	}
}
