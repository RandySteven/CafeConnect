...
func NewUsecases(repo *repositories.Repositories,
	...
	return &Usecases{
		...
		TransactionWorkflow:  transactions_usecases.NewTransactionWorkflow(repo.TransactionHeaderRepository, repo.TransactionDetailRepository, repo.AddressRepository, repo.CartRepository, repo.UserRepository, repo.CafeRepository, repo.CafeFranchiseRepository, repo.ProductRepository, repo.CafeProductRepository, repo.Transaction, topics.TransactionTopic, repo.MidtransTransactionRepository, midtrans, cache.TransactionCache, cache.ProductCache, cache.CheckoutCache, temporal_client.NewWorkflowExecution(temporal), temporal),
		MidtransWorkflow:     midtrans_usecases.NewMidtransWorkflow(temporal, temporal_client.NewWorkflowExecution(temporal), repo.TransactionHeaderRepository, repo.MidtransTransactionRepository, repo.TransactionDetailRepository, repo.CafeProductRepository, repo.ProductRepository, midtrans),
		AutoTransferWorkflow: auto_transfer_usecases.NewAutoTransferWorkflow(temporal, temporal_client.NewWorkflowExecution(temporal), repo.TransactionHeaderRepository, repo.TransactionDetailRepository, repo.AddressRepository, repo.CartRepository, repo.UserRepository, repo.CafeRepository, repo.CafeFranchiseRepository, repo.ProductRepository, repo.CafeProductRepository, repo.Transaction, topics.TransactionTopic, repo.MidtransTransactionRepository, midtrans, cache.TransactionCache, cache.ProductCache, cache.CheckoutCache),
	}
}
